...
import 'package:mihan_s_application1/Vet/lib/widgets/app_bar/appbar_title.dart';
import 'package:mihan_s_application1/Vet/lib/widgets/app_bar/appbar_trailing_image.dart';
import 'package:mihan_s_application1/Vet/lib/widgets/custom_text_form_field.dart';
import 'package:mihan_s_application1/Vet/lib/core/utils/validation_functions.dart';
...
class VetProfileScreen extends GetWidget<VetProfileController> {
  ...
  Widget _buildFive() {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: 25.h),
      child: CustomTextFormField(
        controller: controller.fiveController,
